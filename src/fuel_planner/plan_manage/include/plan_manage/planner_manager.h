...
public:
  ...
  bool checkTrajSafety(NonUniformBspline& traj, const string& context = "trajectory");
...
private:
  ...
  void updateTrajInfo();
  bool isPositionSafe(const Eigen::Vector3d& pos, string& reason);
  double safety_check_dt_;
  double safety_check_distance_;
